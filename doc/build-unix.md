...
Note
---------------------
Always use absolute paths to configure and compile florincoin and the dependencies,
...
# Pick some path to install BDB to, here we create a directory within the florincoin directory
...
Security
--------
To help make your florincoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, florincoin should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, florincoin may be compiled in
