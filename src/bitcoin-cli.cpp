...
std::string HelpMessageCli()
{
    ...
    strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "florincoin.conf") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  florincoin-cli [options] <command> [params]  " + _("Send command to Litecoin Core") + "\n" +
                  "  florincoin-cli [options] help                " + _("List commands") + "\n" +
                  "  florincoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
