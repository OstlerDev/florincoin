...
<context>
    ...
    <message>
        ...
        <translation>florincoin: URIに添付されていたメッセージです。これは参照用としてトランザクションとともに保存されます。注意：このメッセージはLitecoinネットワークを通して送信されるわけではありません。</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Litecoin Alert" admin@foo.com
        ...
        <translation>florincoindを用いる場合や、-server オプションをflorincoin-qtに指定する場合には、設定ファイルにrpcpasswordを設定しなければなりません:
%s
